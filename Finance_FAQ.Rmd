...
`r func(id = "payday", title = "8. What's the difference between hourly and salary payments?")`
...
`r func(id = "payday", title = "8. Can you have different wages/rates for different jobs?")`
